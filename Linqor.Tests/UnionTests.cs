    ...
    public class UnionTests : BinaryOperationTests<int, int, string>
    {
        protected override IReadOnlyList<BinaryTestCase<int, int, string>> GetOperateCases()
        {
            ...
            return new[]
            {
                ...
                create(new int[] { 0, 1, 2 }, new int[] { 2, 3, 4 }, new string[] { "L-0-0", "L-1-1", "L-2-2", "R-1-3", "R-2-4" }),
                create(new int[] { 2, 3, 4 }, new int[] { 0, 1, 2 }, new string[] { "R-0-0", "R-1-1", "L-0-2", "L-1-3", "L-2-4" }),

                create(new int[] { 0, 0, 1, 2, 2 }, new int[] { 0, 1, 1, 2 }, new string[] { "L-0-0", "L-2-1", "L-3-2" }),
                create(new int[] { 0, 0, 1, 3, 3 }, new int[] { 1, 1, 2, 2, 3 }, new string[] { "L-0-0", "L-2-1", "R-2-2", "L-3-3" }),
